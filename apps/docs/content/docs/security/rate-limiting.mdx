...
Rate limits and [budgets](/docs/features/budgets) serve different purposes:

| Feature | Rate Limits | Budgets |
|---------|-------------|---------|
| **Unit** | Request count | Dollar amount |
| **Scope** | Per virtual key | Org, team, or key |
| **Window** | Minute / day | Day / month |
...
- **Events** -- `key.rate_limited` events are emitted and available via [webhooks](/docs/features/webhooks)
