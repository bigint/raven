...
Follow the [Self-Hosting guide](/docs/guides/self-hosting) to deploy Raven on your infrastructure with Docker Compose. Once running, open [http://localhost:3000](http://localhost:3000) and create your account.
