...
- **What is encrypted** -- Provider API keys, SSO secrets, webhook signing keys, and any credentials stored in the platform
...
<Steps>
  ...
  <Step title="Plan Limit Check">
    The organization's monthly request quota is verified.
  </Step>
  ...
  <Step title="Data Residency Enforcement">
    Provider region restrictions are applied. See [Data Residency](/security/data-residency).
  </Step>
...
<Columns cols={2}>
  ...
  <Card title="Data Residency" icon="globe" href="/security/data-residency">
    Enforce regional data requirements.
  </Card>
</Columns>
