...
Prompt injection detection integrates with Raven's [policy engine](/features/policies). You can create policies that:
...
```json Block High-Confidence Injections
{
...
```json Warn on Suspicious Content
{
