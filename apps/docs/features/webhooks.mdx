...
| Event | Description |
|-------|-------------|
| `policy.evaluated` | A policy was evaluated against a request |
| `policy.blocked` | A request was blocked by a policy |
...
| Event | Description |
|-------|-------------|
| `agent.registered` | A new agent identity was created |
| `agent.anomaly.detected` | Anomalous agent behavior was detected |
| `agent.budget.exceeded` | An agent exceeded its budget |
| `agent.tool.invoked` | An agent invoked a tool |

### Compliance Events

| Event | Description |
|-------|-------------|
| `compliance.drift.detected` | Compliance posture changed |
| `compliance.audit.generated` | A compliance report was generated |

### Experiment Events

| Event | Description |
|-------|-------------|
| `experiment.started` | An experiment began running |
| `experiment.completed` | An experiment was completed |
| `experiment.variant.selected` | A request was routed to an experiment variant |
