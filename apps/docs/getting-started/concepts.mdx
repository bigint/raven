...
Raven is an open-source AI gateway you [self-host](/guides/self-hosting) on your own infrastructure. It acts as an intelligent proxy between your application and LLM providers. Every request flows through a pipeline of modules that handle authentication, routing, guardrails, caching, and logging.
