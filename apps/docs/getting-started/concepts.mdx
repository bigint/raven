...
<Columns cols={4}>
  ...
  <Card title="Cohere" icon="robot" />
  <Card title="Groq" icon="robot" />
  <Card title="Perplexity" icon="robot" />
  <Card title="xAI" icon="robot" />
  <Card title="DeepSeek" icon="robot" />
  <Card title="AWS Bedrock" icon="robot" />
  <Card title="Together AI" icon="robot" />
  <Card title="Fireworks" icon="robot" />
  <Card title="Replicate" icon="robot" />
  <Card title="HuggingFace" icon="robot" />
  <Card title="DeepInfra" icon="robot" />
  <Card title="Cerebras" icon="robot" />
  <Card title="SambaNova" icon="robot" />
  <Card title="Databricks" icon="robot" />
  <Card title="Cloudflare" icon="robot" />
  <Card title="Ollama" icon="robot" />
  <Card title="Modal" icon="robot" />
  <Card title="Lepton AI" icon="robot" />
  <Card title="Anyscale" icon="robot" />
  <Card title="Novita AI" icon="robot" />
  <Card title="Voyage AI" icon="robot" />
</Columns>
...
<Steps>
  ...
  <Step title="Prompt Resolution">
    Resolves any prompt template references.
  </Step>
  <Step title="Cache Check">
    Checks semantic cache for matching previous responses.
  </Step>
  <Step title="Routing">
