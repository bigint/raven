...
To enable GitHub or Google sign-in, create OAuth applications and set the corresponding environment variables.
...
2. Create an OAuth 2.0 client with the redirect URI `{BETTER_AUTH_URL}/api/auth/callback/google`
