          ...
          >
            ...
            <form className="space-y-4 px-6 py-5" onSubmit={handleSubmit}>
              ...
              <div className="grid grid-cols-2 gap-3">
                <div className="space-y-1.5">
                  <label className="text-sm font-medium" htmlFor="key-rpm">
                    Rate Limit (RPM)
                  </label>
                  <input
                    className="w-full rounded-lg border border-input bg-background px-3 py-2 text-sm transition-colors focus:outline-none focus:ring-2 focus:ring-ring"
                ...
                <div className="space-y-1.5">
                  <label className="text-sm font-medium" htmlFor="key-rpd">
                    Rate Limit (RPD)
                  </label>
                  <input
                    className="w-full rounded-lg border border-input bg-background px-3 py-2 text-sm transition-colors focus:outline-none focus:ring-2 focus:ring-ring"
          ...
          >
            <div className="px-6 py-5">
              ...
              <p className="mt-2 text-sm text-muted-foreground">
                Are you sure you want to delete this key? Any applications using
