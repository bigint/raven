...
const steps = [
  {
    ...
    description: 'Create your free Raven account to get started. No credit card required.',
    content: (
      <div className="flex items-center gap-3">
        ...
        <span className="text-sm text-muted-foreground">Takes less than 30 seconds</span>
      </div>
    ),
  },
  {
    ...
    content: (
      <div className="bg-muted rounded-lg p-4 text-sm font-mono">
        <p className="text-muted-foreground"># Navigate to Settings → Providers</p>
        <p className="mt-2">
  ...
  },
  {
    ...
    content: (
      <div className="bg-muted rounded-lg p-4 text-sm font-mono">
        <p className="text-muted-foreground"># Navigate to Virtual Keys → Create Key</p>
        <p className="mt-2">
  ...
  return (
    <div className="px-8 py-24">
      <div className="max-w-2xl mx-auto">
        <div className="mb-16">
          <h1 className="text-4xl sm:text-5xl font-bold tracking-tight">Quick Start</h1>
          <p className="mt-4 text-lg text-muted-foreground leading-relaxed">
            Get up and running with Raven in under 5 minutes. Follow these four steps to start
            routing your AI requests.
          </p>
        </div>
